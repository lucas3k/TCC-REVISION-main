...
const carouselItems = [
  {
    imageUrl: require('../../../assets/images/divida.png'),
  ...
  {
    imageUrl: require('../../../assets/images/planejar.png'),
  ...
  {
    imageUrl: require('../../../assets/images/corte.png'),
  ...
  {
    imageUrl: require('../../../assets/images/reserva.png'),
  ...
  {
    imageUrl: require('../../../assets/images/duvida.png'),
